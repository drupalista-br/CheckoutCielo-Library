...
class RedeCard extends BrazilCards {
    ...
    public function authorize($parameters){
        ...
        $parameters['Filiacao']     = $this->membership['filiacao'];     //  9 Merchant store membership number
        $parameters['NumPedido']    = $this->order['pedido'];            // 16 Order number generated by the merchant
        $parameters['IATA']         = $this->membership['IATA'];         //  9 Optional parameter for Airliners. N/A – Send parameter blank
        $parameters['Distribuidor'] = $this->membership['distribuidor']; //  9 Membership number of the outlet/distributor store when B2B. In this case
                                                                         //    the payee (outlet/distributor) issues a payment from its own card in favor
                                                                         //    of the merchant
